...
(function (global, factory) {
  ...
  var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function (e, t) {
    ...
    }else if (global.android !== 'undefined') {
        return java.lang.System.nanoTime() / 1000000;
    }
    else if (global.ios !== 'undefined') {
    ...
    void 0 === t && (t = 0), assert(e.length >= 1, "Pass at least one tensor to concat");var n = convertToTensorArray(e, "tensors", "concat"),
      ...
      return e.size > 0;
    })).length) return n[0];var o = parseAxisParam(t, n[0].shape)[0],
        a = n.map(function (e) {
      return e.shape;
    });assertParamsConsistent(a, o);var i = n;return ENV.engine.runKernel(function (e) {
      return e.concat(n, o);
    }, i, function (e) {
  ...
  var extendStatics$1 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function (e, t) {
  ...
  }serialization.SerializationMap.register(InputLayer);var BaseCallback = function () {
    function e() {
  ...
  }var version$1 = "0.7.5";function preprocessWeightsForLoading(e, t, n, r) {
    ...
    function t(n) {
      var r = e.call(this, {}) || this;if (r.containerNodes = new Set(), r.name = n.name, null == r.name) {
        ...
        s = (E = p[c]).sourceLayer, l = E.nodeIndex, u = E.tensorIndex;assert$1(0 === l, "input layer has >1 nodes"), assert$1(0 === u, "input layer has >1 tensors"), r.inputLayers.push(s), r.inputLayersNodeIndices.push(l), r.inputLayersTensorIndices.push(u);
        ...
        var E = N[I];w(E, S, A);
      }for (var _ = 0, C = z.slice().reverse(); _ < C.length; _++) {
        m[(K = C[_]).id] = K, K.id in f || (f[K.id] = 0);var L = f[K.id],
            k = null == y[K.outboundLayer.id] ? 0 : y[K.outboundLayer.id];L = Math.max(L, k), y[K.outboundLayer.id] = L, v[K.outboundLayer.id] = K.outboundLayer, f[K.id] = L;for (h = 0; h < K.inboundLayers.length; h++) {
          var x = K.inboundLayers[h],
              T = (l = K.nodeIndices[h], x.inboundNodes[l]),
              R = null == f[T.id] ? 0 : f[T.id];f[T.id] = Math.max(L + 1, R), m[T.id] = T;
        }
      }var O = {};for (var D in f) {
        (L = f[D]) in O || (O[L] = []), O[L].push(m[D]);
      }var M = {};for (var P in y) {
        (L = y[P]) in M || (M[L] = []), M[L].push(v[P]);
      }var V = Object.keys(M).map(function (e) {
        return parseInt(e, 10);
      }).sort(reverseNumberCompare);r.layers = [];for (var F = 0, B = V; F < B.length; F++) {
        var U = M[L = B[F]];U.sort(function (e, t) {
          var n = b[e.id],
        ...
        return parseInt(e, 10);
      }).sort(reverseNumberCompare);for (var $ = r.inputs.slice(), q = [], G = 0, J = V; G < J.length; G++) for (var H = 0, Z = O[L = J[G]]; H < Z.length; H++) {
      ...
      var t = normalizeShapeList(e);if (t.length !== this.inputLayers.length) throw new ValueError("Invalid inputShape argument " + e + ": model has " + this.inputLayers.length + " tensor inputs.");for (var n = {}, r = 0; r < t.length; r++) {
        ...
        var I = S[r];assert$1(I in n), w.push(n[I]);
      ...
      }for (var _ = [], C = [], L = [], k = 0, x = this.outputs; k < x.length; k++) {
        assert$1((i = x[k]).id in n, "Could not compute output " + i.name + " : " + i.id);var T = n[i.id],
            R = T[0];o = T[1];L.push(R.shape), _.push(R), C.push(o);
      }return [_, C, L];
      ...
      var n = {},
        ...
        var z = (d = b[v])[0],
            w = d[1],
            S = d[2];assert$1(z in n);var A = (E = n[z]).inboundNodes[w].outputTensors;m.push(A[S]);
      }for (var I = 0, N = t.outputLayers; I < N.length; I++) {
        z = (d = N[I])[0], w = d[1], S = d[2];assert$1(z in n);var E;A = (E = n[z]).inboundNodes[w].outputTensors;y.push(A[S]);
    ...
    function t(t) {
      ...
      return __awaiter$1(this, void 0, void 0, function () {
        var f,
          ...
          switch (I.label) {case 0:
              if (null == r && (r = 32), null == i && (i = 1), null == u && (u = !0), null == p && (p = 0), f = !1, null != s && null != l && (f = !0), null != d && (f = !0, null == h)) throw new ValueError("Can only use `validationSteps` when doing step-wise training, i.e., `stepsPerEpoch` must be set.");if (null != (m = this.checkNumSamples(t, r, h, "steps_per_epoch")) && (y = range$1(0, m)), this.history = new History(), v = new BaseLogger(g), o = (o = null == o ? [v] : [v].concat(o)).concat([this.history]), a > 0) throw new NotImplementedError("Verbose mode is not implemented yet.");return (b = new CallbackList(o)).setModel(this), b.setParams({ epochs: i, initialEpoch: p, samples: m, steps: h, batchSize: r, verbose: a, doValidation: f, metrics: c }), [4, b.onTrainBegin()];case 1:
              I.sent(), this.stopTraining_ = !1, z = function (i) {
                var a, o, c, p, d;return __generator$1(this, function (g) {
                  switch (g.label) {case 0:
                          ...
                          switch (p.label) {case 0:
                              ...
                              return p.sent(), tidy(function () {
                                var p = c[i][0],
                                  ...
                                  var z = A.testLoop(s, l, r);for (y = 0; y < n.length; ++y) {
                                    v = n[y], b = z[y];keep(b), a["val_" + v] = b;
                                  }
                                }
                              }), [4, b.onBatchEnd(i, u)];case 2:
                              return p.sent(), disposeTensorsInLogs(u), w.stopTraining_ ? [2, "break"] : [2];}
                        });
                      ...
                      return g.sent(), w.stopTraining_ ? [2, "break"] : [2];}
                });
              }, w = this, S = p, I.label = 2;case 2:
              return S < i ? [5, z(S)] : [3, 5];case 3:
        ...
        var r,
          ...
          switch (A.label) {case 0:
              ...
              if (A.trys.push([1,, 3, 4]), checkBatchSize(r = null == n.batchSize ? 32 : n.batchSize), i = this.standardizeUserData(e, t, !1, r), a = i[0], o = i[1], s = !1, l = void 0, u = void 0, c = void 0, p = !1, null != n.validationData && n.validationData.length > 0) {
                ...
                return "val_" + e;
              }))) : (v = null, c = [], b = y.slice()), z = standardizeCallbacks(n.callbacks), [4, this.fitLoop(m, f, y, r, n.epochs, n.verbose, z, v, c, n.shuffle, b, n.initialEpoch, null, null, n.yieldEvery)];case 2:
  ...
  }serialization.SerializationMap.register(Model);var Sequential = function (e) {
    function t(t) {
    ...
    }return __extends$1(t, e), t.prototype.add = function (e) {
      var n,
    ...
    return Input(e);
  }serialization.SerializationMap.register(Sequential);var Activation = function (e) {
    function t() {
      return null !== e && e.apply(this, arguments) || this;
    }return __extends$1(t, e), t.prototype.getConfig = function () {
      return {};
  ...
  }serialization.SerializationMap.register(Softmax);var ReLU = function (e) {
    function t(t) {
  ...
  }(Layer);serialization.SerializationMap.register(ReLU);var LeakyReLU = function (e) {
    function t(t) {
  ...
  }(Layer);serialization.SerializationMap.register(Reshape);var Permute = function (e) {
    function t(t) {
  ...
  }(Layer);serialization.SerializationMap.register(Permute);var Embedding = function (e) {
    function t(t) {
    ...
    function t(t) {
      ...
      var n = this;return tidy(function () {
        var r = null == t ? null : t.mask,
            ...
            a = null == t ? null : t.initialState;if (e = getExactlyOneTensor(e), null == a && (a = n.stateful ? n.states : n.getInitialState(e)), null != r) throw new NotImplementedError("Masking is not implemented for RNN yet");var o = Array.isArray(n.cell.stateSize) ? n.cell.stateSize.length : 1;if (a.length !== o) throw new ValueError("RNN Layer has " + o + " state(s) but was passed " + a.length + " initial state(s).");var s = e.shape[1];n.unroll && console.warn("Ignoring unroll = true for RNN layer, due to imperative backend.");var l = { training: i },
            u = rnn(function (e, t) {
          var r = n.cell.call([e].concat(t), l);return [r[0], r.slice(1)];
        }, e, a, n.goBackwards, null, null, n.unroll, s),
            c = u[0],
            p = u[1],
            h = u[2];n.stateful && n.resetStates(h);var d = n.returnSequences ? p : c;return n.returnState ? [d].concat(h) : d;
      });
        ...
        if (2 !== (e = e).length) throw new ValueError("GRUCell expects 2 input Tensors (inputs, h, c), got " + e.length + ".");var r = null != t.training && t.training,
          ...
          var c = sliceAlongLastAxis(n.kernel.read(), 0, n.units),
            ...
            var S = sliceAlongFirstAxis(n.bias.read(), 0, n.units),
              ...
              E = void 0,
              _ = void 0;0 < n.recurrentDropout && n.recurrentDropout < 1 ? (N = mul(i, u[0]), E = mul(i, u[1]), _ = mul(i, u[2])) : (N = i, E = i, _ = i), a = n.recurrentActivation.apply(add(b, dot$1(N, d))), o = n.recurrentActivation.apply(add(z, dot$1(E, g))), s = n.activation.apply(add(w, dot$1(mul(o, _), f)));
        } else {
          0 < n.dropout && n.dropout < 1 && (e = mul(e, l[0]));var C = dot$1(e, n.kernel.read());n.useBias && (C = biasAdd(C, n.bias.read())), 0 < n.dropout && n.dropout < 1 && (i = mul(i, u[0]));var L = dot$1(i, sliceAlongLastAxis(n.recurrentKernel.read(), 0, 2 * n.units)),
              k = (b = sliceAlongLastAxis(C, 0, n.units), z = sliceAlongLastAxis(C, n.units, n.units), sliceAlongLastAxis(L, 0, n.units)),
              x = sliceAlongLastAxis(L, n.units, n.units);a = n.recurrentActivation.apply(add(b, k)), o = n.recurrentActivation.apply(add(z, x));w = sliceAlongLastAxis(C, 2 * n.units, n.units);var T = dot$1(mul(o, i), sliceAlongLastAxis(n.recurrentKernel.read(), 2 * n.units, n.units));s = n.activation.apply(add(w, T));
      ...
      var n = this;return tidy(function () {
        var r = null != t.training && t.training;if (3 !== (e = e).length) throw new ValueError("LSTMCell expects 3 input Tensors (inputs, h, c), got " + e.length + ".");var i = e[1],
          ...
          var h = sliceAlongLastAxis(n.kernel.read(), 0, n.units),
              ...
              w = void 0,
              S = void 0,
              A = void 0;0 < n.dropout && n.dropout < 1 ? (z = mul(e, c[0]), w = mul(e, c[1]), S = mul(e, c[2]), A = mul(e, c[3])) : (z = e, w = e, S = e, A = e);var I = dot$1(z, h),
              N = dot$1(w, d),
              E = dot$1(S, g),
              _ = dot$1(A, f);if (n.useBias) {
            var C = sliceAlongFirstAxis(n.bias.read(), 0, n.units),
                L = sliceAlongFirstAxis(n.bias.read(), n.units, n.units),
                k = sliceAlongFirstAxis(n.bias.read(), 2 * n.units, n.units),
                x = sliceAlongFirstAxis(n.bias.read(), 3 * n.units, n.units);I = biasAdd(I, C), N = biasAdd(N, L), E = biasAdd(E, k), _ = biasAdd(_, x);
          }var T = void 0,
              R = void 0,
              O = void 0,
              D = void 0;0 < n.recurrentDropout && n.recurrentDropout < 1 ? (T = mul(i, p[0]), R = mul(i, p[1]), O = mul(i, p[2]), D = mul(i, p[3])) : (T = i, R = i, O = i, D = i), o = n.recurrentActivation.apply(add(I, dot$1(T, m))), s = n.recurrentActivation.apply(add(N, dot$1(R, y))), l = add(mul(s, a), mul(o, n.activation.apply(add(E, dot$1(O, v))))), u = n.recurrentActivation.apply(add(_, dot$1(D, b)));
        } else {
  ...
  }serialization.SerializationMap.register(StackedRNNCells);var Wrapper = function (e) {
    function t(t) {
  ...
  }serialization.SerializationMap.register(Bidirectional);var globalMaxPool1d = globalMaxPooling1d,
  ...
  var __assign$2 = Object.assign || function (e) {
    ...
    function e() {
      ...
      var t = this,
          ...
          r = !1,
          n = [],
          o = e.node.reduce(function (e, o) {
        return e[o.name] = t.mapNode(o), t.isControlFlow(o) && (a = !0), t.isDynamicShape(o) && (r = !0), "Placeholder" === o.op && n.push(e[o.name]), e;
      }, {}),
          s = [],
          i = [];return Object.keys(o).forEach(function (e) {
        var t = o[e];t.inputNames.forEach(function (e) {
          var a = getNodeNameAndIndex(e)[0];t.inputs.push(o[a]), o[a].children.push(t);
        }), 0 === t.inputs.length && s.push(t);
      }), Object.keys(o).forEach(function (e) {
        var t = o[e];0 === t.children.length && i.push(t);
      }), { nodes: o, inputs: s, outputs: i, placeholders: n, withControlFlow: a, withDynamicShape: r };
    ...
    return __awaiter$2(this, void 0, void 0, function () {
      var r, n, o, s, i, p, u, m, l, d, c, f, y, h, g, N, P, b, x, I, v, O, w, V, k, T, $, _, S, A, D, j, E, C, L;return __generator$2(this, function (R) {
        switch (R.label) {case 0:
    ...
    function e(e) {
      ...
      if (!this.graph.withControlFlow && !this.graph.withDynamicShape) for (var e = this.graph.inputs.slice(), t = {}; e.length > 0;) {
      ...
      var a = this;this.checkInput(e), this.checkInputShapeAndType(e);var r = {};return tidy(function () {
        var n = new ExecutionContext(a._weightMap, r),
            o = a.compiledOrder.reduce(function (e, t) {
          return e[t.name] = executeOp$15(t, e, n), e;
        }, __assign$2({}, a.weightMap, e));return a.findOutputs(o, n, t);
      });
      ...
      return __awaiter$2(this, void 0, void 0, function () {
        var a, r, n, o;return __generator$2(this, function (s) {
          switch (s.label) {case 0:
              a = this.graph.inputs.map(function (e) {
                return { node: e, contexts: t.currentContext };
              }), r = __assign$2({}, this.weightMap, e), n = {}, s.label = 1;case 1:
              return a.length > 0 ? (o = this.processStack(a, t, r, n), [4, Promise.all(o)]) : [3, 3];case 2:
              return s.sent(), [3, 1];case 3:
              return [2, r];}
        });
      });
    }, e.prototype.processStack = function (e, t, a, r) {
      for (var n = this, o = [], s = function () {
        var s = e.pop();t.currentContext = s.contexts;var p = "";"enter" === s.node.op && getParamValue("isConstant", s.node, a, t) && (p = getNodeNameAndIndex(s.node.name, t)[0]);var u = executeOp$15(s.node, a, t);p || (p = getNodeNameAndIndex(s.node.name, t)[0]);var m = t.currentContext;u instanceof Promise ? o.push(u.then(function (o) {
          return a[p] = o, t.currentContext = m, n.processChildNodes(s.node, e, t, a, r), o;
        })) : (a[p] = u, i.processChildNodes(s.node, e, t, a, r));
      }, i = this; e.length > 0;) s();return o;
